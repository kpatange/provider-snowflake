...
// GetInitParameters of this DatabaseRole
func (tr *DatabaseRole) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this DatabaseRole
func (tr *DatabaseRole) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
