...
type AccountInitParameters struct {
	...
	// (String) Specifies authentication policy for the current account. For more information about this resource, see docs.
	...
	// (String) Specifies feature policy for the current account.
	...
	FeaturePolicy *string `json:"featurePolicy,omitempty" tf:"feature_policy,omitempty"`
	...
	// (String) Specifies packages policy for the current account.
	// Specifies [packages policy](https://docs.snowflake.com/en/developer-guide/udf/python/packages-policy) for the current account.
	PackagesPolicy *string `json:"packagesPolicy,omitempty" tf:"packages_policy,omitempty"`
...
// Account is the Schema for the Accounts API. Resource used to manage the account you are currently connected to. This resource is used to set account parameters and other account-level settings. See ALTER ACCOUNT https://docs.snowflake.com/en/sql-reference/sql/alter-account documentation for more information on resource capabilities.
